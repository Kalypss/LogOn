...
<Dialog @close="resetForm">
  <DialogTrigger>
    <Button variant="destructive" class="flex w-full align-middle text-center cursor-pointer active:scale-95 active:shadow-inner transition-transform group">
       <BadgeAlert class="" /> Signaler un bug
    </Button>
  </DialogTrigger>
  <DialogContent class="">
    <DialogHeader>
