-- Initialisation complète de la base de données LogOn Password Manager
-- Schéma complet avec sécurité renforcée et architecture zéro-connaissance
...
CREATE TABLE users (
    ...
    is_active BOOLEAN DEFAULT TRUE NOT NULL, -- Statut du compte (corrigé)
...
-- Table des permissions par entrée
...
COMMENT ON COLUMN users.is_active IS 'Statut actif du compte utilisateur';
